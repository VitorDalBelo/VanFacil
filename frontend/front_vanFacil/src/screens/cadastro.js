   ...
   return (
      <>
         ...
         <ScrollView style={estilos.Scroll}>
            ...
            <TextInput placeholder="nome" style={estilos.textoInput} value={nome} onChangeText={(texto) => setNome(texto)} />

            <Texto style={estilos.textoRotulo}>{'telefone'}</Texto>
            <TextInput placeholder="11900000000" style={estilos.textoInput} value={telefone} onChangeText={(texto) => setTelefone(texto)} />
