...
function Adress() {
   const { loading, endereco, setEndereco, complemento, setComplemento, phone, setPhone, selectedCampus, setSelectedCampus } =
...
function UserData() {
   const { nome, setNome, email, setEmail, senha, setSenha, confirSenha, setConfirSenha, cadastroGoogle, loading } =
      useContext(SteperContext);
   ...
   return (
      <>
         ...
         <View style={estilos.inputContainer}>
            <TextInput
               editable={!(loading || cadastroGoogle)}
               value={confirSenha}
   ...
   return (
      ...
      >
         <View style={estilos.page}>
            ...
            <View style={estilos.form}>{ChoseConp(step)}</View>
            ...
            <View style={estilos.signupBtn}>
               {loading ? (
                  ...
                  <TouchableOpacity>
                     <Button
                        title={step === lastStep ? 'Cadastrar' : 'Continuar'}
                        onPress={() => {
                           cadastrar();
                        }}
                     />
